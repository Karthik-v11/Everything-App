...
/// (Requirement 11).
///
/// [watchAll] streams every document at once; screens filter it by
/// [DocumentEntry.projectId] rather than running a per-project query, so a
/// document saved anywhere refreshes every screen showing it.
